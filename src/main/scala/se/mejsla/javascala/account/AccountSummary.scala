package se.mejsla.javascala.account

/*
 * "Java-code in Scala" counterpart of the se.mejsla.java.account classes. Note that they could be put in separate files just
